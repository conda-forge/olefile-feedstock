About olefile-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/olefile-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/decalage2/olefile
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5655&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/olefile-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `olefile` can be installed with `conda`:
...
```
mamba install olefile
```

It is possible to list all of the versions of `olefile` available on your platform with `conda`:
...
```
mamba search olefile --channel conda-forge
```
...
mamba repoquery search olefile --channel conda-forge

# List packages depending on `olefile`:
mamba repoquery whoneeds olefile --channel conda-forge

# List dependencies of `olefile`:
mamba repoquery depends olefile --channel conda-forge
```
